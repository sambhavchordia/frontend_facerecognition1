        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 sm:p-8 border-2 border-slate-200 shadow-xl mt-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Employee ID Input (Teachers only) */}
              {formData.userType === 'teacher' && (
                <div>
                  <label className="block text-slate-700 text-sm font-semibold mb-2">
                    Employee ID
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full bg-emerald-50 border-2 border-emerald-200 rounded-xl pl-12 pr-4 py-3 text-slate-800 placeholder-slate-400 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all duration-300"
                    />
                  </div>
                </div>
              )}

              {/* Department Input (Teachers only) */}
              {formData.userType === 'teacher' && (
                <div>
                  <label className="block text-slate-700 text-sm font-semibold mb-2">
                    Department
