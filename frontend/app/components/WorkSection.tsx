    ...
    <section className="py-20">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
          Face Recognition follows a streamlined four-step process to deliver accurate and secure results.
        </p>
      </div>
      ...
      <div className="mt-16 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-200">
        <div className="text-center">
          ...
          <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
            Join thousands of users who trust Face Recognition for secure and accurate identification.
          </p>
