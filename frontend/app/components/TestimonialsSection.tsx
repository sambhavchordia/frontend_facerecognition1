  ...
  const testimonials = [
    {
      ...
      avatar: "SJ",
      rating: 5,
      content: "Face Recognition has revolutionized our attendance system. The accuracy is incredible and students love how quick and easy it is. No more paper registers!",
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8 border-2 border-blue-200">
            ...
            <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
              Experience the future of attendance management and see why educational institutions worldwide trust Face Recognition
            </p>
